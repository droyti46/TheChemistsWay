...
@export_enum("Start", "Enemies", "Chest",
			 "PassedEnemies", "Last") var room_type = 0
...
const DOORS_INFO = {
	Vector2.LEFT: {
		"alternative_index": 1,
		"coords": Vector2i(0, 3),
		"scene": preload("res://game/game_floor/dungeon_generator/rooms_templates/chapter1_forest/environment/doors/forest_door_left.tscn")
	},
	Vector2.DOWN: {
		"alternative_index": 2, 
		"coords": Vector2i(5, 6),
		"scene": preload("res://game/game_floor/dungeon_generator/rooms_templates/chapter1_forest/environment/doors/forest_door_bottom.tscn")
	},
	Vector2.RIGHT: {
		"alternative_index": 3,
		"coords": Vector2i(10, 3),
		"scene": preload("res://game/game_floor/dungeon_generator/rooms_templates/chapter1_forest/environment/doors/forest_door_right.tscn")
	},
	Vector2.UP: {
		"alternative_index": 4,
		"coords": Vector2(5, 0),
		"scene": preload("res://game/game_floor/dungeon_generator/rooms_templates/chapter1_forest/environment/doors/forest_door_top.tscn")
	}
}
...
func open_doors() -> void:
	...
	"""
	Проигрывает анимацию открытия дверей
	"""
...
func get_type() -> String:
	return ["Start", "Enemies", "Chest", "PassedEnemies", "Last"][room_type]
